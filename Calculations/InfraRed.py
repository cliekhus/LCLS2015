...
folder = "C:/Users/chels/OneDrive/Documents/UW/Mixed-Valence-Complexes/LCLS2015/Calculations/FeRu-freq-xyzs/"
...
for ii in range(numlines):
    ...
    VectorFile(numbers[index[ii]], wavenumbers[index[ii]], False, "harmonic" + str(ii) + ".png", ii == 0)
