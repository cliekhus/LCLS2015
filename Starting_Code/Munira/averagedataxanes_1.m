...
for aa=1:length(Runs);
    ...
    dataon=[dataon; load(strcat('delta_T_xan',str1,'_1.mat'),'xan_on')];
    dataoff=[dataoff; load(strcat('delta_T_xan',str1,'_1.mat'),'DiodeU_off')];
    energy= load(strcat('delta_T_xan',str1,'_1.mat'),'monoaxis');
    times=load(strcat('delta_T_xan',str1,'_1.mat'),'Timesaxis');
end
% figure
...
save('Fsxanavg_1.mat','energy','doffavgx','dataoffsmx','deltaTx','deltaTsmx');
