...
plt.plot(incident_axis, xasoff(incident_axis, *params_XAS), label='LCLS ground state fit')
plt.plot(incident_axis, HERFD_FeRu*scale_factor, marker = '', label = 'APS ground state', linestyle = '--')
plt.plot(incident_axis, xasoff(incident_axis, *params_II)*scale_factor, label='APS ground state fit')
